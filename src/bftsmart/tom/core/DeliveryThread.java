                ...
                if (consensuses.size() > 0) {
                    ...
                    if (requests != null && requests.length > 0) {
                        ...
                        if (controller.hasUpdates()) {
                            ...
                            if(this.receiver instanceof ParallelServiceReplica){
                                //If parallel executions are configured, it is necessary to wait for all threads to stop;
                            ...
                            if(this.receiver instanceof ParallelServiceReplica){
                                //If parallel executions are configured, resume all thrads;
                                ((ParallelServiceReplica)this.receiver).getReconfBarrier().await();
