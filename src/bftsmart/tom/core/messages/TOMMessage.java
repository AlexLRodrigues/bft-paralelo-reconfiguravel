...
//******* EDUARDO END **************//
     ...
     * @param groupId groupId for parallelism
     */
    public TOMMessage(int sender, int session, int sequence, byte[] content, int view, int groupId) {
        this(sender, session, sequence, content, view, TOMMessageType.ORDERED_REQUEST, groupId);
    }
     ...
     * @param groupId groupId for parallelism
     */
    public TOMMessage(int sender, int session, int sequence, byte[] content, int view, TOMMessageType type, int groupId) {
        this(sender, session, sequence, -1, content, view, type,groupId);
    }
     ...
     * @param session The session id of the sender
     * @param sequence The sequence number created based on the message type
     * @param operationId The operation sequence number disregarding message
     * type
     * @param content The command to be executed
     * @param view The view in which the message was sent
     * @param type Ordered or Unordered request
