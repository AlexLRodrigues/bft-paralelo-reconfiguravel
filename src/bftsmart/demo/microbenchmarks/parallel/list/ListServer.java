...
import bftsmart.tom.parallelism.LazyPolicy;
import bftsmart.tom.parallelism.AgressivePolicy;
import bftsmart.tom.parallelism.IntervalPolicy;
import bftsmart.tom.parallelism.ParallelMapping;
import bftsmart.tom.parallelism.ParallelServiceReplica;
import bftsmart.tom.parallelism.ParallelServiceReplicaBatch;
...
public final class ListServer implements SingleExecutable, Recoverable {
    ...
    public ListServer(int id, int interval, int maxThreads, int minThreads, int initThreads, int entries, boolean context, boolean batch) {
        ...
        if (initThreads == 0) {
            ...
            replica = new ServiceReplica(id, true, this, this);
        } else if (batch) {
            System.out.println("Replica in parallel execution model. (BATCH)");
            //replica = new ParallelServiceReplicaBatch(id, initThreads, maxThreads, this, this);
        } else {
            ...
            //replica = new ParallelServiceReplica(id, maxThreads, minThreads, initThreads, this, this, new LazyPolicy());
            //replica = new ParallelServiceReplica(id, maxThreads, minThreads, initThreads, this, this, new AgressivePolicy());
            replica = new ParallelServiceReplica(id, maxThreads, minThreads, initThreads, this, this, new IntervalPolicy());
    ...
    public static void main(String[] args) {
        if (args.length < 8) {
            System.out.println("Usage: ... ListServer <processId> <measurement interval> <maxNum threads> <minNum threads> <initialNum threads> <initial entries> <context?> <batch?>");
            System.exit(-1);
        }
        ...
        new ListServer(processId, interval, maxNT, minNT, initialNT, entries, context, b);
    }
