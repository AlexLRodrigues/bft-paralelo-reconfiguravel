 ...
 */
public class ParallelLatencyServer implements SingleExecutable, Recoverable {
    ...
    public ParallelLatencyServer(int id, int interval, int replySize) {
        //ParallelMapping m = new ParallelMapping(10);
        
        replica = new ParallelServiceReplica(id, 10, this, this, null);
    ...
    public static void main(String[] args) {
        ...
        new ParallelLatencyServer(processId, interval, replySize);
    }
